...
List<Karakter> welcomeFromJson(String str) =>
    List<Karakter>.from(json.decode(str).map((x) => Karakter.fromJson(x)));

String welcomeToJson(List<Karakter> data) =>
...
class Karakter {
  ...
  factory Karakter.fromJson(Map<String, dynamic> json) => Karakter(
    id: json["id"],
    name: json["name"],
    alternateNames:
