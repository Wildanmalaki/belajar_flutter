...
import 'package:belajar_flutter/tugas%2011-12/view/login_page.dart';
...
class SplashScreenTugas11 extends StatefulWidget {
  ...
  @override
  State<SplashScreenTugas11> createState() => _SplashScreenTugas10State();
}

class _SplashScreenTugas10State extends State<SplashScreenTugas11> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 3), () {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => LoginPageTugas11()), 
      );
    });
  }
